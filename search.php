        ...
        <table border="0" cellspacing="0">
            ...
            <?php 
             if(isset($_GET['keyword'])){
                $search = $_GET['keyword'];
                $sql = "SELECT * FROM `data_siswa` WHERE id_siswa like'%$search%' or nama_siswa like'%$search%' or jenis_kelamin like'%$search%' or tanggal_lahir like'%$search%' or alamat like'%$search%' or kelas like'%$search%' or jurusan like'%$search%' or telepon like'%$search%'";
